...
\begin{frame}{Robots sota l'aigua?}
...
\begin{frame}{Els "sensits" d'un robot submar\'i?}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \centering
    \fbox{\includegraphics[width=0.9\linewidth]{img/sensors_auvs.png}}
  \end{columns}
\end{frame}
...
\begin{frame}{Qu\`e podem fer amb aquests robots?}
  ...
  \centering
  \begin{tabular}{cccc}
    \fbox{\includegraphics[width=0.2\textwidth]{img/slide29_science.jpg}} &
    \fbox{\includegraphics[width=0.2\textwidth]{img/ship_wreck.jpg}}&
    \fbox{\includegraphics[width=0.2\textwidth]{img/slide29_energy.jpg}} &
    \fbox{\includegraphics[width=0.2\textwidth]{img/slide29_ecology.jpg}} \\
     \\
